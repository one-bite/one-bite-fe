...
const ResumeCourseButton = ({courseName}: ResumeCourseButtonProps ) => {
  return (
      <BigButton className="m-16 mt-4 p-8 w-[280px] h-[220px] bg-blue-400 hover:bg-blue-400 text-white justify-start items-start shadow-[0_12px_0_#3B82F6] active:shadow-[0_8px_0_#3B82F6]">
