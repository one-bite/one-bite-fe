...
const DailyStreakCard = ({ streakleftquiz, streakHistory }: DailyStreakCardProps) => {
    return (
        <MainSectionCard className="w-full max-w-full md:max-w-[880px] m-2 md:my-8 md:mx-1 p-0">
            <div className="flex flex-col md:flex-row md:justify-between md:items-start w-full px-3 py-2 md:py-4 md:px-10">
                    ...
                    <div className="flex flex-col gap-2 md:px-8 p-0 items-center md:items-start text-center md:text-left md:mt-4 mt-2">
                        {streakleftquiz > 0 ? (
                            ...
                            <>
                                <h1 className="text-xl md:text-3xl font-linebold">
                                    오늘의 문제를<br/>
                                    <span className="text-2xl md:text-4xl text-orange-500 font-linebold">
                                        모두
                                    </span> 풀었습니다!
                                </h1>
                                <p className="text-sm md:text-sm text-gray-600 font-line mt-1">
